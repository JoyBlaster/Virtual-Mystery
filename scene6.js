...
const vnData = "scene6.json";
    ...
    document.getElementById('VisualNovelEngine6').insertAdjacentHTML("beforebegin", htmlData);
    ...
    //Handles page turning when continue button is pressed 
